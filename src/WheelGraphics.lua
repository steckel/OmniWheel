...
function WheelGraphics:New(parent_frame, --[[WheelGeometry ]]wheel_geometry)
  ...
  self.sector_one_font:SetPoint("LEFT", self.sector_one_texture, "CENTER", text_distance_from_icon, 0);
  ...
  local sector_two_x, sector_two_y =
    polar_to_cartesian(bisecting_radius_sector_2, icon_distance_from_center);
  ...
  self.sector_two_font:SetPoint("BOTTOMLEFT", self.sector_two_texture, "CENTER", 0, text_distance_from_icon);
  ...
  local sector_three_x, sector_three_y =
    polar_to_cartesian(bisecting_radius_sector_3, icon_distance_from_center);
  ...
  self.sector_three_font:SetPoint("BOTTOM", self.sector_three_texture, "CENTER", 0, text_distance_from_icon);
  ...
  local sector_four_x, sector_four_y =
    polar_to_cartesian(bisecting_radius_sector_4, icon_distance_from_center);
  ...
  self.sector_four_font:SetPoint("BOTTOMRIGHT", self.sector_four_texture, "CENTER", 0, text_distance_from_icon);
  ...
  self.sector_five_texture:SetPoint("CENTER", parent_frame, "CENTER", -icon_distance_from_center / ui_scale, 0);
  ...
  self.sector_five_font:SetPoint("RIGHT", self.sector_five_texture, "CENTER", -1 * text_distance_from_icon, 0);
  ...
  local sector_six_x, sector_six_y =
    polar_to_cartesian(bisecting_radius_sector_6, icon_distance_from_center);
  ...
  self.sector_six_font:SetPoint("TOPRIGHT", self.sector_six_texture, "CENTER", 0, -1 * text_distance_from_icon);
  ...
  local sector_seven_x, sector_seven_y =
    polar_to_cartesian(bisecting_radius_sector_7, icon_distance_from_center);
  ...
  self.sector_seven_font:SetPoint("TOP", self.sector_seven_texture, "CENTER", 0, -1 * text_distance_from_icon);
  ...
  local sector_eight_x, sector_eight_y =
    polar_to_cartesian(bisecting_radius_sector_8, icon_distance_from_center);
